...
@push('meta-seo')
    <meta name="description" value="Category The Fastest and Latest Blog about entertaintment and historical world">
    <meta name="keyword" value="category bacayuk!, baca yuk, kategori bacayuk">
    <meta property="og:title" content="Category {{ $category . ' - BacaYuk' }}" />
    <meta property="og:url" value="{{ url()->current() }}">
    <meta property="og:site_name" content="BacaYuk" />
    <meta property="og:description" value="Category The Fastest and Latest Blog about entertaintment and historical world">
...
@section('title', 'Category ' . $category . ' - CUNY')
...
@section('content')
    ...
    <div class="container">
        <div class="mb-4">
            ...
            <p style=" font-family: 'Righteous', sans-serif;">hasil kategori : <strong
                    style="color: #FFB600">{{ $category }}</strong></p>
